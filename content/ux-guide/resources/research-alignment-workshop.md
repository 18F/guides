...
---
{% comment %}
Note that the permalink here uses /research/ so it's misleading about where this page actually sits. The sidenav in the Jekyll site also does not contain this page, so I'm just leaving the internal sidenav here.
{% endcomment %}
