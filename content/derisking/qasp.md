...
{% comment %}
  TODO: The title and header are clashing here. In the original, the page H1 is "Sample Quality Assessment Surveillance Plan (QASP)", and the title in <head> is "QASP | De-risking government technology | 18F"
  TODO: Styles are in the assets folder, but not yet loaded.
{% endcomment %}

# Sample Quality Assessment Surveillance Plan (QASP)

<div markdown="1" class="chapter__img-container">
  {% image_with_class "assets/derisking/img/qasp-checks.svg" "chapter__img" "" %}
</div>
