  ...
  <ul class="usa-card-group flex-align-start">
    <li class="usa-card tablet:grid-col-6">
      <div class="usa-card__container">
        ...
        <div class="usa-card__body">
          <p><a href="{{ '/derisking-government-tech/software-solutions/' | url }}"><strong>Understanding and choosing a software solution</strong></a>, which explains:</p>
          <ol>
    ...
    <li class="usa-card tablet:grid-col-6">
      <div class="usa-card__container">
        ...
        <div class="usa-card__body">
          <p><a href="{{ '/derisking-government-tech/principles/' | url }}"><strong>Four key principles for effective custom software development</strong></a>:</p>
          <ol>
    ...
    <li class="usa-card tablet:grid-col-6">
      <div class="usa-card__container">
        ...
        <div class="usa-card__body">
          <p><a href="{{ '/derisking-government-tech/buying-development-services/' | url }}"><strong>Buying custom software development services</strong></a>, including:</p>
          <ol>
    ...
    <li class="usa-card tablet:grid-col-6">
      <div class="usa-card__container">
        ...
        <div class="usa-card__body">
          <p><a href="{{ '/derisking-government-tech/vendor-management/' | url }}"><strong>Working with a vendor development team</strong></a>, including:</p>
          <ol>
