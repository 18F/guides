...
(The optional step to release a draft solicitation during market research is included because it’s more likely to result in qualified proposals than a [Request for Information (RFI)]({{ "/derisking-government-tech/resources/market-research/#requests-for-information" | url }}), which is more commonly used. Further, [verbal interviews](#adding-a-key-personnel-clause) are mentioned because 18F strongly recommends them to validate the approach provided in written proposals.) 
