...
| --- | --- | --- | --- |
| **Tested Code** | Code delivered under the order must have substantial test code coverage and a clean code base  | Minimum of 90% test coverage of all code | Combination of manual review and automated testing |
...
| **Accessibility** | W3C Accessibility Guidelines 2.2 AA standards | 0 errors reported using an automated scanner, and 0 errors reported in manual testing | [Pa11y](https://github.com/pa11y/pa11y) |
